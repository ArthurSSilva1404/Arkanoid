...
Criar um projeto organizado, modular, funcional e visualmente estável.

Implementar fases progressivas, níveis de dificuldade, itens especiais e sistema de pontuação com ranking salvo em arquivo.
...
Lançar a bola / iniciar rodada	Espaço
Pausar o jogo	P
Voltar ao menu	Esc
...
Rebater a bola usando a barra (paddle) para destruir todos os blocos de cada fase, avançar progressivamente e obter a maior pontuação possível.
...
P	Pontos extras	Concede pontos bônus
!	Inversor	Inverte temporariamente a direção do movimento da barra
